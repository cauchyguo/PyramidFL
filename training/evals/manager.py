...
def process_cmd(yaml_file):
    ...
    log_file_name = os.path.join(
        current_path, f"{job_name}_logging_{time_stamp}")
...
def terminate(job_name):
    ...
    for vm_ip in job_meta['vms']:
        ...
        os.system(
            f"ssh {job_meta['user']}{vm_ip} '/mnt/home/lichenni/anaconda3/envs/oort/bin/python {current_path}/shutdown.py {job_name}'")
